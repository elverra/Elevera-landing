...
const CTA = ({ cmsContent }: CTAProps) => {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(to bottom right, #6E3AD6, #4C1D95)",
      }}
    >
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Join Elverra Global?
          </h2>
          <p className="text-lg mb-8 opacity-90">
            Become a Client today and unlock a world of exclusive benefits,
          ...
          <div className="mt-10 pt-8 border-t border-white/20">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              <div className="bg-white/10 px-4 py-2 rounded-md">
                ...
                <span className="text-xs ml-2 bg-green-500 text-white px-2 py-0.5 rounded-full">
                  Active
                </span>
              </div>
              <div className="bg-white/5 px-4 py-2 rounded-md opacity-60">
                <span className="font-medium text-lg">Nigeria</span>
                <span className="text-xs ml-2 bg-gray-500 text-white px-2 py-0.5 rounded-full">
                  Coming Soon
                </span>
              </div>
              <div className="bg-white/5 px-4 py-2 rounded-md opacity-60">
