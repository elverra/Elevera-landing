...
const translations = {
  en: {
    ...
    "selector.not_available_desc":
      "This country is not yet available. Currently, only Mali and International are active.",
  ...
  fr: {
    ...
    "selector.not_available_desc":
      "Ce pays n'est pas encore disponible. Actuellement, seuls le Mali et International sont actifs.",
