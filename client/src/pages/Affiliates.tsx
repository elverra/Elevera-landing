...
const Affiliates = () => {
  ...
  return (
    <MembershipGuard
      requiredFeature="canAccessAffiliates"
      requiredTier="premium"
    >
      <Layout>
        <PremiumBanner
          title="Elverra Affiliate Network"
          description="Join thousands of successful affiliates earning commissions by promoting Elverra Global across our network of markets"
              ...
              <Card className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-xl mb-8 opacity-90">
                    Join our affiliate program and start earning 10% commission
                    on every referral. Note: Your affiliate code becomes active
                    only after manager approval to ensure proper orientation.
                  </p>
                  <Link
                    to="/selectCountry"
