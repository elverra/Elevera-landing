        ...
        <div className="container mx-auto px-4">
              ...
              <TabsContent value="how-it-works" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Follow these simple steps to acquire products through our
                    ...
                    <div className="space-y-6">
                      <div className="flex">
                        <div className="mr-4">
                          <div className="bg-club66-purple/10 h-10 w-10 rounded-full flex items-center justify-center">
                            <span className="font-bold text-club66-purple">
                              1
                            </span>
                          </div>
                        </div>
                        <div>
                          ...
                          <p className="text-gray-600">
                            Browse our catalog of partner merchants or bring
                            quotes from preferred vendors for products you wish
                            to purchase. We work with a wide network of
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Complete the Hire Purchase application form with
                            your product details and preferred payment term. Our
                            team will review your application and provide a
                            quick decision based on your client tier.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Pay the required down payment (typically 20-30% of
                            the product value) through mobile money, bank
                            transfer, or at our office locations.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Take immediate possession of your product! We'll
                            handle the purchase and arrange delivery to your
                            specified address, or you can pick it up from the
                            merchant location.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Pay your monthly installments according to your
                            agreement. Once all payments are complete, the
                            product is fully yours! Payment reminders are sent
                            via SMS and email.
                          </p>
                        </div>
                      </div>
              ...
              <TabsContent value="requirements" className="mt-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Check if you meet the criteria for our Hire Purchase
                      program.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-center">
                            ...
                            <span>
                              Active Club66 Global client status for at least 2
                              months
                            </span>
                          </li>
                          <li className="flex items-center">
                            <Check className="h-5 w-5 text-green-500 mr-2" />
                            <span>
                              Steady source of income (employment or business)
                            </span>
                          </li>
                          <li className="flex items-center">
                            <Check className="h-5 w-5 text-green-500 mr-2" />
                            <span>
                              Good payment history with Elverra Global
                            </span>
                          </li>
                          <li className="flex items-center">
                            <Check className="h-5 w-5 text-green-500 mr-2" />
                            <span>
                              Ability to make the required down payment
                            </span>
                          </li>
                          <li className="flex items-center">
                            <Check className="h-5 w-5 text-green-500 mr-2" />
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-center">
                            <Check className="h-5 w-5 text-green-500 mr-2" />
                            <span>
                              Completed Hire Purchase application form
                            </span>
                          </li>
                          <li className="flex items-center">
                            <Check className="h-5 w-5 text-green-500 mr-2" />
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Missed payments incur late fees and may affect your credit
                      history with Elverra Global. If you anticipate payment
                      difficulties, contact us immediately to discuss
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      ...
                      Early repayment may qualify for an interest reduction,
                      depending on your client tier and the terms of your
                      agreement.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      All products maintain their manufacturer's warranty. For
                      certain products, we offer additional protection plans
                      that can be added to your hire purchase agreement.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium">
                      Can I get multiple items on hire purchase?
                    </h4>
                    <p className="text-sm text-gray-600 mt-1">
                      Yes, clients can have multiple hire purchase agreements
                      simultaneously, subject to overall credit limit based on
                      your client tier and payment capacity.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-8">
              Our Hire Purchase program helps you acquire the items you need
              without the burden of full upfront payment. Apply today and start
              enjoying your purchase while paying over time.
            </p>
            <Button
              onClick={() => {
                const hotline = "/selectCountry";
