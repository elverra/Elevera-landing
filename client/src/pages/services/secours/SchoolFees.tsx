  ...
  const howItWorks = [
    {
      step: 1,
      title: "Subscribe",
      description: "Join our School Fees emergency plan",
    },
    {
      step: 2,
      title: "Build Credits",
      description: "Accumulate tokens through monthly purchase",
    },
    {
      step: 3,
      title: "Emergency Request",
      description: "Submit request when you need assistance",
    },
    {
      step: 4,
      title: "Get Relief",
      description: "Receive immediate financial support",
    },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Ensure your child's education never stops. Our School Fees
                emergency support provides immediate financial assistance when
                you need it most.
              </p>
              <Badge className="text-lg px-6 py-2 bg-blue-500">
                Education Support
              </Badge>
            </div>
            ...
            <Card className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xl mb-8 opacity-90">
                  Join thousands of parents who trust us to protect their
